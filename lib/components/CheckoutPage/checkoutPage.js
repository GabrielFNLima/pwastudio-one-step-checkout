...
import { useCheckoutPWAStudio } from '../../talons/CheckoutPagePWAStudio/useCheckoutPWAStudio';
...
const CheckoutPage = props => {
    ...
    if (orderNumber && orderDetailsData) {
        ...
        switch (layout) {
            case '1column':
                layoutClass = classes.layout_1column;
                break;
            case '2columns':
                layoutClass = classes.layout_2columns;
                break;
            case '3columns':
            default:
                layoutClass = classes.layout_3columns;
        }
        ...
        checkoutContent = (
            <div className={checkoutContentClass}>
                ...
                <div className={`${classes.checkoutContainer} ${layoutClass}`} data-layout="2columns">
